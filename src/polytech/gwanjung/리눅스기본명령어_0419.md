...
### whoami
접속한 사용자가 누구인지 확인하는 명령어

whoami

### whatis
명령어의 간단한 설명을 확인할 수 있다.
ex. whais mkdir
...
mkdir -p 옵션 예제에서 실제로 하위디렉토리가 생성되었다는 ㅎ것을 보여주기 위해 사용하였다.
...
리눅스나 유닉스는 윈도우와 같이 휴지통이 있지만 명령어로 삭제할 때는 파일이 바로 삭제되기 때문에 조심하자.
예제:
